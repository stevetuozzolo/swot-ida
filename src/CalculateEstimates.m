...
for r=1:D.nR,
    ...
    Estimate.nhatAll(r,:)=calcnhat(AllObs.w(r,:),AllObs.h(r,:),AllObs.hmin(r),Estimate.A0hat(r)+AllObs.dA(r,:),...
    Prior.Wa(r),Prior.Ha(r),c1,Estimate.x1hat(r),Estimate.nahat(r),BjerklienOpt);    
end
...
for i=1:C.N,
    for r=1:D.nR,
        ...
        nhatAll(r,:)=calcnhat(AllObs.w(r,:),AllObs.h(r,:),AllObs.hmin(r),Estimate.A0hat(r)+AllObs.dA(r,:), ...
            Prior.Wa(r),Prior.Ha(r),c1,...
            C.thetax1(r,i),C.thetana(r,i),BjerklienOpt);    
    end
...
clear nhat
for r=1:D.nR,
    nhat(r,:)=calcnhat(AllObs.w(r,:),AllObs.h(r,:),AllObs.hmin(r),Prior.meanA0(r)+AllObs.dA(r,:),Prior.Wa(r),Prior.Ha(r),c1,...
        Prior.meanx1(r),Prior.meanna(r),BjerklienOpt);                
end
